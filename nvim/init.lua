...
-- Setup default indentation to two spaces
vim.opt.shiftwidth = 2    -- Sets the number of spaces per indent
vim.opt.tabstop = 2
vim.opt.expandtab = true  -- Replaces tabs with spaces
vim.opt.autoindent = true -- Automatically sets the next line's indentation
vim.opt.smartindent = true -- Uses smarter indentation logic
...
-- testing text wraping
--vim.api.nvim_buf_set_keymap(0, 'v', ',"', [[c[<c-r>"]()<esc>]], { noremap = false })
--vim.api.nvim_buf_set_keymap(0, 'v', ",[", [[c[<c-r>"]<esc>]], { noremap = false })
--vim.api.nvim_buf_set_keymap(0, 'v', ',"', [[c\"<c-r>"\"<esc>]], { noremap = false })
